...
plot(SNAIVE_seas) #repeating seasonal component from previous year
...
```{r}
# Model 5: Simple moving average on deseasoned data
...
# Model 7:  Simple exponential smoothing on deseasoned data
...
SARIMA_forecast <- forecast(object = SARIMA_autofit, h = 36) #fit and then call the forecast function
